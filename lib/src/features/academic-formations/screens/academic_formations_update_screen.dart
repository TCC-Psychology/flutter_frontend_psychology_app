...
class AcademicFormationUpdateScreen extends StatefulWidget {
  final String formationId;
  const AcademicFormationUpdateScreen({Key? key, required this.formationId})
      : super(key: key);

  @override
  State<AcademicFormationUpdateScreen> createState() =>
      _AcademicFormationUpdateScreen();
}

class _AcademicFormationUpdateScreen
    extends State<AcademicFormationUpdateScreen> {
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Universidade $formationId',
  ...
  fetchAcademicFormation() async {
    EasyLoading.show(status: 'Carregando...');
    var fetchedAcademicFormation =
        await academicFormationsService.fetchAcademicFormationById(formationId);
    if (fetchedAcademicFormation != null) {
      academicFormation = fetchedAcademicFormation;
      setState(() {
        institution.text = academicFormation.institution;
        course.text = academicFormation.course;
        description.text = academicFormation.description ?? "";
        selectedStartDate = academicFormation.startDate;
        selectedEndDate = academicFormation.endDate;
      });
    } else {
