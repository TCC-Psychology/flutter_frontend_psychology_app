...
class AcademicFormationsScreen extends StatefulWidget {
  const AcademicFormationsScreen({Key? key}) : super(key: key);

  @override
  State<AcademicFormationsScreen> createState() => _AcademicFormationsScreen();
}

class _AcademicFormationsScreen extends State<AcademicFormationsScreen> {
